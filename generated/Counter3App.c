...
SM_INPUT(mod1,x163,x151,x152) { //top1
x150();
uint8_t* x153 = x151;
int x154 = x152;
x29(x153,x154);
...
SM_INPUT(mod1,x178,x165,x166) { //top2
x150();
uint8_t* x167 = x165;
int x168 = x166;
x58(x167,x168);
...
static void x193 (int x181) {
bool x182 = x181 == 1;
if (x182) {
int x183 = 2;
int x184 = x183;
uint8_t x185 = (uint8_t ) x184;
uint8_t* x186 = &x185;
size_t x187 = sizeof(x185);
x178(x186,x187);
} else {
}
}
...
puts("main started");
x212();
buttons_register_callback(Button2,x193);
