...
SM_FUNC(mod2) void x332 (int x316,bool x317,int* x318,bool* x319) {
bool x321 = x317;
if (x321) {
bool* x323 = x319;
*x323 = true;
...
int* x322 = x318;
*x322 = x320;
lcd_printf_int("%d ", x320);
} else {
bool* x323 = x319;
*x323 = true;
}
}
SM_INPUT(mod2,x363,x341,x342) { //top8
x340();
bool x346 = false;
int x347;
int x348 = x347;
...
puts("main started");
x399();
buttons_register_callback(Button2,x379);
